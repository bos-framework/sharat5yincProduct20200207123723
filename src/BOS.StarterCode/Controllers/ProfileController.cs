...
namespace BOS.StarterCode.Controllers
{
    ...
    public class ProfileController : Controller
    {
        ...
        public ProfileController(IConfiguration configuration, IHttpContextAccessor contextAccessor)
        {
                ...
                if (!string.IsNullOrEmpty(username))
                {
                    ...
                    if (User != null && User.FindFirst(c => c.Type == "Username") != null)
                    {
                        ...
                        if (!User.FindFirst(c => c.Type == "Username").Value.ToString().Equals(username))
                        {
                            ...
                            else if (updatedUsernameResponse != null && updatedUsernameResponse.StatusCode == System.Net.HttpStatusCode.Unauthorized)
                            {
                                return "Token Expired, Please try again";//Token Expired
                            }
                            else
            ...
            try
            {
                ...
                if (HttpContext != null && HttpContext.Session != null)
                {
                    ...
                    if (User != null)
                    {
                        ...
                        {
                            //string message = "Token Expired, Please try again";//Token Expired
                        }
                    }
